...
# libvorbis library build directory name - build_<abi> for release and build_<abi>_d for debug
build_dir=""
...
for abi in "${abi_list[@]}"; do
    for config in "${config_list[@]}"; do
        ...
        cmake .. -DCMAKE_TOOLCHAIN_FILE=$ANDROID_NDK_HOME/build/cmake/android.toolchain.cmake \
                 ...
                 -DCMAKE_INSTALL_PREFIX=/home/scar/Repository/libvorbis/${build_dir} \
