...
# This script will build libvorbis for Android using the NDK
...
# It will generate build directories for each ABI/configuration in libvorbis subdirectory.
...
vorbis_root=$(echo ${ROOT_LOC}/libvorbis*)
...
for abi in "${abi_list[@]}"; do
    for config in "${config_list[@]}"; do
        ...
        cmake .. -DCMAKE_TOOLCHAIN_FILE="${toolchain}" \
                 ...
                 -DCMAKE_INSTALL_PREFIX=${vorbis_root}/${build_dir} \
